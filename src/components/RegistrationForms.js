    ...
    <div className="max-w-2xl mx-auto p-6 bg-gray-100 shadow-md rounded-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="p-4 bg-white rounded-lg shadow-md">
          ...
          <input type="text" name="name1" value={userInput.name1} onChange={handleChange} placeholder="Captain Name" className="w-full p-2 border rounded mb-2" required />
          <input type="tel" name="phone1" value={userInput.phone1} onChange={handleChange} placeholder="Captain Phone" className="w-full p-2 border rounded mb-2" required />
           {  /* Email */}
        ...
        <div className="p-4 bg-white rounded-lg shadow-md">
          ...
          <input type="text" name="name2" value={userInput.name2} onChange={handleChange} placeholder="Player 1 Name" className="w-full p-2 border rounded mb-2" required />
          <input type="tel" name="phone2" value={userInput.phone2} onChange={handleChange} placeholder="Player 1 Phone" className="w-full p-2 border rounded mb-2" required />
        ...
        <div className="p-4 bg-white rounded-lg shadow-md">
          ...
          <input type="text" name="name3" value={userInput.name3} onChange={handleChange} placeholder="Player 2 Name" className="w-full p-2 border rounded mb-2" />
          <input type="tel" name="phone3" value={userInput.phone3} onChange={handleChange} placeholder="Player 2 Phone" className="w-full p-2 border rounded mb-2" />
        ...
        <div className="p-4 bg-white rounded-lg shadow-md">
          ...
          <input type="text" name="name4" value={userInput.name4} onChange={handleChange} placeholder="Player 3 Name" className="w-full p-2 border rounded mb-2" />
          <input type="tel" name="phone4" value={userInput.phone4} onChange={handleChange} placeholder="Player 3 Phone" className="w-full p-2 border rounded mb-2" />
