      ...
      <div className="container mx-auto relative">
          ...
          >
            <Link to="/" className="flex items-center gap-2 no-underline">
              ...
              <div className="flex flex-col">
                <span className="text-lg sm:text-2xl font-spark text-black tracking-wide">
                  TechSpark
                </span>
              </div>
              {/* <img 
          ...
          <div className="hidden md:flex items-center gap-8">
            {routes.map((link) => (
              ...
              >
                {link.label}
                <span
                  className="absolute left-0 bottom-[-4px] w-0 h-0.5 
        ...
        >
          {routes.map((link) => (
            ...
            >
              <span
                className="relative inline-block font-medium text-lg transition-transform duration-300 ease-in-out 
                       hover:scale-110 tracking-widest
