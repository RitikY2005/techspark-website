  ...
  return (
    ...
    <nav className="px-4 py-3 sm:py-4 w-full top-0 z-50 sm:opacity-75">
      <div className="container mx-auto relative">
        ...
        <motion.div 
          ref={navRef}
          className={`${isMenuOpen ? 'flex' : 'hidden'} absolute top-10 left-0 w-full z-9999999 md:hidden flex-col gap-4 pt-4 rounded-md shadow-[0px_0px_10px_black] bg-black/80 text-cyber-pink`}
          initial={false}
