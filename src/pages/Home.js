  ...
  return (
    <CyberLayout>
      ...
      <div className="relative min-h-screen flex flex-col justify-center items-center">
        ...
        <motion.div
          className="absolute w-[150px] sm:w-[300px] md:w-[600px] h-[150px] sm:h-[300px] md:h-[600px] opacity-5 z-10"
          initial={{ rotate: 0 }}
          animate={{ rotate: 360 }}
        ...
        >
          <motion.h1 
            className="text-4xl sm:text-6xl md:text-7xl mb-4 sm:mb-6 text-[#2a3135] font-bold font-tech 
